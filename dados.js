let dados = [
    {
        ...
        temas: ["multimodal", "google", "linguagem", "geração de texto", "código", "redação", "redações"]
    },
    {
        titulo: "Chat-GPT",
        ...
        temas: ["multimodal", "linguagem", "geração de texto", "código", "imagens", "redação", "redações"]
    },
    {
        ...
        temas: ["produtividade", "microsoft", "multimodal", "assistente", "automação", "linguagem", "geração de texto", "código", "redação", "redações"]
    },
    {
        titulo: "Mistral AI",
        ...
        temas: ["multimodal", "linguagem", "geração de texto", "código", "redação", "redações"]
    },
    {
        titulo: "Claude AI",
